...
const CampaignBlockModal = ({ blockingCampaign, onClose, blockReason, setBlockReason, onConfirm }) => {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        <div style={{ display: 'flex', gap: '0.75rem' }}>
          ...
          <LiquidButton type="button" variant="error" onClick={onConfirm} style={{ flex: 1 }}>Block Campaign</LiquidButton>
        </div>
      </div>
    </div>
  );
...
export default CampaignBlockModal;
