...
export default function ChatTab({
  ...
  return (
    <div className="tab-pane chat-dashboard-container" style={{ animation: 'fadeIn 0.3s ease' }}>
          ...
          <div className="conversation-list">
            {loadingConv ? (
              ...
              <div className="empty-chat-state">
                ...
                <p>No conversations yet. Only brands can start a chat.</p>
              </div>
              ...
              return (
                ...
                >
                  <div className="conv-avatar">
                    {otherUser?.avatar ? <img src={resolveAssetUrl(otherUser.avatar)} alt="" /> : otherUser?.name?.[0]}
                  </div>
              ...
              <div className="chat-window-header">
                ...
                <div className="chat-header-user">
                  <div className="avatar sm">
                    {conversations.find(c => c._id === selectedConvId)?.participants?.find(p => p._id !== user?._id)?.avatar ? 
